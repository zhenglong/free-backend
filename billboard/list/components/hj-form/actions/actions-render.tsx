...
import HjActionButton from './index';
...
interface ActionButtonDataClass {
    new(form: HjForm<any, any>): ActionButtonData;
}
...
abstract class ActionButtonData {
    ...
    constructor(form: HjForm<any, any>) {
        this.form = form;
    }
...
export default function getActionDatas(buttons: ActionButtonType[], form: HjForm<any, any>): ReactElement[] {
    ...
    return res.map(d => <HjActionButton text={d.text} onClick={() => {
        return d.onDo();
    }} />);
}