...
export interface HjRichTextFieldProps extends HjFieldProps {

}

interface HjRichTextFieldState {
 ...
 * 
 */
export default class RichTextField extends Component<HjRichTextFieldProps, HjRichTextFieldState> implements HjFieldWidget {

    editorRef: RefObject<BraftEditor>;

    constructor(props: HjRichTextFieldProps) {
        super(props);
