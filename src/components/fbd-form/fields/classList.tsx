...
export interface FbdClassListSelectProps extends FbdFieldProps {

}

/**
 * 
 * TODO: 继承FbdFieldState，value应该放到state中
 * 否则antd有些组件的值不会被清掉，后期会继续优化不必要的渲染循环
 * 
 */
interface FbdClassListSelectState {
    classes: ClassData[];
 ...
 * 
 */
export default class FbdClassListSelectField extends Component<FbdClassListSelectProps, FbdClassListSelectState> implements FbdFieldWidget {

    constructor(props: FbdClassListSelectProps) {
        super(props);
            ...
            <fieldCollectorContext.Consumer>
                {
                    (ctx: FieldCollector) => {
                        ...
                        return (
                            this.state.visible ? <Form.Item label={this.props.title} className="fbd-class-list-select">
                                <div className="fbd-class-list-select-inner">
