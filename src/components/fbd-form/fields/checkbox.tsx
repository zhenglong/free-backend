...
import { FbdFieldProps, FbdFieldState } from './fbd-field';
...
export interface FbdCheckboxProps extends CheckboxProps, FbdFieldProps {
    valueSet: DictionaryEntry[]
}

interface FbdCheckboxState extends FbdFieldState {
    visible: boolean;
}
 ...
 * 
 */
export default class FbdCheckbox extends Component<FbdCheckboxProps, FbdCheckboxState> implements FbdFieldWidget {
    
    innerWidgetRef: RefObject<CheckboxGroup>;

    constructor(props: FbdCheckboxProps) {
        super(props);
    ...
    componentWillReceiveProps(nextProps: FbdCheckboxProps) {
        ...
        this.setState({
            ...
            // 在第一次初始化时，尽量依赖fbd-form.computedDidMount里调用updateQueryCondition
