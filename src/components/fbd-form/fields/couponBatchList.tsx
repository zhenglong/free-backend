...
export interface FbdCouponBatchListSelectProps extends FbdFieldProps {

}

interface FbdCouponBatchListSelectState {
...
/**
 * 
 * TODO: 是否可以在这里使用FbdTable，这样会形成业务组件包含业务组件;不确定这么做对复杂度有多大影响
 * 目前是所有业务组件都是基于antd组件库实现，不会互相包含
 *
 * TODO: 不支持触发值更新
 * 
 */
export default class FbdCouponBatchListSelectField extends Component<FbdCouponBatchListSelectProps, FbdCouponBatchListSelectState> implements FbdFieldWidget {

    constructor(props: FbdCouponBatchListSelectProps) {
        super(props);
            ...
            <fieldCollectorContext.Consumer>
                {
                    (ctx: FieldCollector) => {
                        ...
                        return (
                            this.state.visible ? <Form.Item label={this.props.title} className="fbd-coupon-batch-list-select">
                                <div className="fbd-coupon-batch-list-select-inner">
                                    <div>
