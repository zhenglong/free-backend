...
export interface FbdImgSizeConstraintFieldProps extends FbdFieldProps {
    /**
     * 
     * 0: 宽字段id；1: 高字段id
     * 
...
interface FbdImgSizeConstraintFieldState {
    visible: boolean;
}

export default class ImgSizeConstraintField extends Component<FbdImgSizeConstraintFieldProps, FbdImgSizeConstraintFieldState> implements FbdFieldWidget {
    innerWidthInput: RefObject<InputNumber>;
    innerHeightInput: RefObject<InputNumber>;
    widthVal: number;
    heightVal: number;

    constructor(props: FbdImgSizeConstraintFieldProps) {
        super(props);
