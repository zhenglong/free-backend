...
export interface FbdImgUploadProps extends UploadProps, FbdFieldProps {
    
}

interface FbdImgUploadState {
    /**
     * 
     * 已上传文件列表
     * 
 ...
 * 
 */
export default class FbdImgUploadField extends Component<FbdImgUploadProps, FbdImgUploadState> implements FbdFieldWidget {

    constructor(props: FbdImgUploadProps) {
        super(props);
            ...
            <fieldCollectorContext.Consumer>
                {
                    (ctx: FieldCollector) => {
                        ...
                        return (
                            this.state.visible ? <div className="fbd-img-upload">
