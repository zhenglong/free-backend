// 是一个工厂组件（也是一种高阶组件）
// 可以配置出不同的能力的FbdForm，当然不同能力需要自定义实现；工厂只提供最基本的能力，
...
export interface FbdFormProps extends FormProps {
...
// 支持（查询/导出）按钮，并且可扩展
export default class FbdForm<S extends FbdFormProps, T extends FormStateData> extends Component<S, T> {
    ...
    getDataView(isCheckDynamic: boolean = false): any {
        ...
        this.ctx.fieldWidgets.forEach((elem: FbdFieldWidget) => {
    ...
    render() {
        ...
        return (
            <Form {...formItemLayout} {...this.props} className="fbd-form">
